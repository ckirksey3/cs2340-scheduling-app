 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Dan Doozan");
		  toPrint += p1.toString("ddoozan3");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Jeff");
		  toPrint += p2.toString("jpansini3");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Sam");
		  toPrint += p3.toString("sbell30");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Caleb");
          toPrint += p4.toString("ckirksey3");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Caleb");
          toPrint += p5.toString("ckirksey3");
